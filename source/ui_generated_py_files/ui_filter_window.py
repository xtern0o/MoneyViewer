...
"}")
        ...
        self.dt_1 = QtWidgets.QDateTimeEdit(self.frame)
        self.dt_1.setMinimumSize(QtCore.QSize(0, 40))
        ...
        self.dt_2 = QtWidgets.QDateTimeEdit(self.frame)
        self.dt_2.setMinimumSize(QtCore.QSize(0, 40))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 644, 266))
